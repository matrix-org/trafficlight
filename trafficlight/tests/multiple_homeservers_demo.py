...
class SendMessagesAcrossFederationTest(Test):
    ...
    async def run(self, client_one: Client, client_two: Client, server: HomeServer, second_server: HomeServer) -> None:
        ...
        await client_one.invite_user("@" + client_two.localpart + ":" + second_server.server_name)
